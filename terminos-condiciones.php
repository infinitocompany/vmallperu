...
<html>  
    <head>
        <meta charset="utf-8">
        <title>VirtualMall | Terminos y Condiciones</title>
    ...
    <div class="canvas-content">
        <div class="row content">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 ">
                ...
                <?php $cn->query("SELECT WebPagID, WebPagNam, WebPagCon FROM itech_web_page WHERE WebPagLnk='terminos-condiciones'");?>
