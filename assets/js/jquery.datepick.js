...
function Datepicker() {
	...
	this.regional[''] = { // US/English
		...
		nextStatus: 'Mostrar el mes siguiente', // Status text for the next month command
		nextJumpText: '&gt;&gt;', // Text for the next year command
		nextJumpStatus: 'Mostrar el año siguiente', // Status text for the next year command
		...
		closeStatus: 'Cerrar el calendario', // Status text for the close command
		...
		dayStatus: 'DD, M d, yyyy', // Status text for selectable days
		defaultStatus: 'Seleccionar una fecha', // Status text shown by default
...
$.extend(Datepicker.prototype, {
	...
	_generateContent: function(target, inst) {
		...
		for (var name in inst.options.commands) {
			...
			/*addCommand('link', 'a href="javascript:submit-form-date();"', 'a', name,*/
		...
		for (var week = 0; week < numWeeks; week++) {
			...
			for (var day = 0; day < 7; day++) {
				...
				days += this._prepare(renderer.day, inst).replace(/\{day\}/g,
					...
					/*(selectable ? '<a href="javascript:submit-form-date();" ' : '<span') +*/
	...
	_generateMonthSelection: function(inst, year, month, minDate, maxDate, monthHeader) {
		...
		var selector = '{link:prev}<select class="' + this._monthYearClass +
		...
		if (yearRange == 'any') {
			selector = '<select class="anio ' + this._monthYearClass + ' ' + this._anyYearClass +
				'" title="' + inst.options.yearStatus + '">' +
				'<option>' + year + '</option></select>' +
				'<input class="' + this._monthYearClass + ' ' + this._curMonthClass +
				month + '" value="' + year + '">{link:next}';
		}
		else {
			...
			selector = '<select class="anio ' + this._monthYearClass +
				'" title="' + inst.options.yearStatus + '">';
