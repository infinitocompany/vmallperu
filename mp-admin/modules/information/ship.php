...
<a href="./">Inicio </a> - <a href="#" class="list">Costos de Envio</a><br /><br /><br />
<div class="MOForm">
	<fieldset class="search">
		<legend>Buscar Informaci&oacute;n</legend>
		<table>
			<tr>
				<td><label for="search">Ingrese el t&eacute;rmino de su b&uacute;squeda</label></td>
...
$(document).ready(function(){
	...
	$("form#save").live("submit", function(){
		if(!required('#name', 'Porfavor, ingrese un distrito.')) return false;
		if(!required('#price', 'Porfavor, ingrese un costo de envio.')) return false;
		mp_submit(mod, 2);
		return false;
	});
