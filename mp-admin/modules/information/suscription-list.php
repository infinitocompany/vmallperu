...
$cn->query("SELECT id, email, status FROM suscription WHERE LOWER(email) like '%$search%' ORDER BY email ASC");
$cnt=1;
?>
<table width="100%" class="listing">
	...
	<tbody>
		...
		<tr>
			...
			<td><a href="./?mod=32&amp;id=<?php echo $row['id']; ?>"><?php echo mp_unscape($row['email']); ?></a></td>
