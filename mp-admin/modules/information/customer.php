...
<h1>Clientes</h1>
<a href="./">Inicio </a> - <a href="#" class="list">Clientes</a><br /><br /><br />
<div class="MOForm">
...
$(document).ready(function(){
	...
	$("form#save").live("submit", function(){
		if(!required('#name', 'Porfavor, ingrese un nombre para la imagen.')) return false;
		if(!required('#file_guid', 'Escoja una Imagen')) return false;
		mp_submit(mod, 2);
		return false;
	});
